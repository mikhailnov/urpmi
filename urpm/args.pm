...
foreach my $k ('allow-medium-change', 'auto', 'auto-select', 'clean', 'restricted', 'download-all:s', 'no-download-all!', 'force-req-update', 'no-force-req-update', 'force', 'expect-install!', 'justdb', 'no-priority-upgrade', 'noscripts', 'replacefiles', 'p', 'P', 'previous-priority-upgrade=s', 'root=s', 'test!', 'verify-rpm!', 'update',
